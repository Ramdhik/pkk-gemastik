...
export default function SignUpWarga() {
  ...
  return (
    <View className="justify-center flex-1 px-6 bg-white">
      <Text className="mb-6 text-2xl font-bold text-center">Daftar - Masyarakat</Text>
      ...
      <TextInput className="px-4 py-2 mb-4 border border-gray-300 rounded-md" placeholder="Tanggal Lahir (YYYY-MM-DD)" value={birthDate} onChangeText={setBirthDate} />
